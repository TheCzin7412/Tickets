...
var datos_tickets_empresas
var boton_primero_tickets_pendientes_empresas = document.getElementById("boton_paginador_primero_tickets_pendientes_empresas")
var boton_anterior_tickets_pendientes_empresas = document.getElementById("boton_paginador_anterior_tickets_pendientes_empresas")
var boton_siguiente_tickets_pendientes_empresas = document.getElementById("boton_paginador_siguiente_tickets_pendientes_empresas")
var boton_ultimo_tickets_pendientes_empresas = document.getElementById("boton_paginador_ultimo_tickets_pendientes_empresas")
var cuerpo_tickets_pendientes_empresas = document.getElementById("tabla_tickets_pendientes_empresas")
var indicador_pagina_tickets_pendientes_empresas= document.getElementById("boton_paginador_cantidad_tickets_pendientes_empresas")
var cantidad_vistas_tickets_pendientes_empresas
var pagina_actual_tickets_pendientes_empresas 

function tomar_datos_tickets_pendientes_empresas()
{
    let contenedor = document.getElementById("tabla_tickets_pendientes_empresas")
    //cantidad_vistas_tickets_pendientes_empresas = document.getElementById("cantidad_tickets_pendientes_empresas").value
    pagina_actual_tickets_pendientes_empresas = 1
    // alert(cantidad_vistas)   

    contenedor.innerHTML = ""
    let ajax = new XMLHttpRequest()
       ajax.open("POST","../controlador/tomar_datos_tickets_pendientes_empresas.php")
       ajax.send()
       ajax.onreadystatechange =function () 
       {
            if (ajax.readyState == 4) 
            {
                if (ajax.status == 200) 
                {
                    ...
                    datos_tickets_empresas = JSON.parse(ajax.responseText)
                    // console.log(datos)
                    paginador_tickets_pendientes_empresas(datos_tickets_empresas,pagina_actual_tickets_pendientes_empresas,cantidad_vistas_tickets_pendientes_empresas,boton_anterior_tickets_pendientes_empresas,boton_siguiente_tickets_pendientes_empresas,boton_primero_tickets_pendientes_empresas,boton_ultimo_tickets_pendientes_empresas,cuerpo_tickets_pendientes_empresas,indicador_pagina_tickets_pendientes_empresas)
                }
                if (ajax.status == 400) 
                {
...
boton_siguiente_tickets_pendientes_empresas.addEventListener("click", function(){
    pagina_actual_tickets_pendientes_empresas++
    paginador_siguiente_tickets_pendientes_empresas(datos_tickets_empresas,pagina_actual_tickets_pendientes_empresas,cantidad_vistas_tickets_pendientes_empresas,boton_anterior_tickets_pendientes_empresas,boton_siguiente_tickets_pendientes_empresas,boton_primero_tickets_pendientes_empresas,boton_ultimo_tickets_pendientes_empresas,cuerpo_tickets_pendientes_empresas,indicador_pagina_tickets_pendientes_empresas)
})

boton_anterior_tickets_pendientes_empresas.addEventListener("click", function(){
    pagina_actual_tickets_pendientes_empresas--
    paginador_anterior_tickets_pendientes_empresas(datos_tickets_empresas,pagina_actual_tickets_pendientes_empresas,cantidad_vistas_tickets_pendientes_empresas,boton_anterior_tickets_pendientes_empresas,boton_siguiente_tickets_pendientes_empresas,boton_primero_tickets_pendientes_empresas,boton_ultimo_tickets_pendientes_empresas,cuerpo_tickets_pendientes_empresas,indicador_pagina_tickets_pendientes_empresas)
})

boton_primero_tickets_pendientes_empresas.addEventListener("click", function(){
    pagina_actual_tickets_pendientes_empresas = 1 
    paginador_primera_tickets_pendientes_empresas(datos_tickets_empresas,pagina_actual_tickets_pendientes_empresas,cantidad_vistas_tickets_pendientes_empresas,boton_anterior_tickets_pendientes_empresas,boton_siguiente_tickets_pendientes_empresas,boton_primero_tickets_pendientes_empresas,boton_ultimo_tickets_pendientes_empresas,cuerpo_tickets_pendientes_empresas,indicador_pagina_tickets_pendientes_empresas)
})

boton_ultimo_tickets_pendientes_empresas.addEventListener("click", function(){

    var tamano = datos_tickets_empresas.length;
    var numero_paginas=tamano/cantidad_vistas_tickets_pendientes_empresas;
    numero_paginas=Math.ceil(numero_paginas);
    pagina_actual_tickets_pendientes_empresas = numero_paginas

    paginador_ultima_tickets_pendientes_empresas(datos_tickets_empresas,pagina_actual_tickets_pendientes_empresas,cantidad_vistas_tickets_pendientes_empresas,boton_anterior_tickets_pendientes_empresas,boton_siguiente_tickets_pendientes_empresas,boton_primero_tickets_pendientes_empresas,boton_ultimo_tickets_pendientes_empresas,cuerpo_tickets_pendientes_empresas,indicador_pagina_tickets_pendientes_empresas)
})

function paginador_tickets_pendientes_empresas(arreglo_rutas,pagina_actual,cantidad_vistas,btn_atras,btn_adelante,btn_primera,btn_ultima,cuerpo_paginador,pagina_paginador){
...
function paginador_siguiente_tickets_pendientes_empresas(arreglo_rutas,pagina_actual,cantidad_vistas,btn_atras,btn_adelante,btn_primera,btn_ultima,cuerpo_paginador,pagina_paginador){
    // pagina_actual++;
    var cuerpo = "";
    cuerpo_paginador.innerHTML = "";
...
function paginador_anterior_tickets_pendientes_empresas(arreglo_rutas,pagina_actual,cantidad_vistas,btn_atras,btn_adelante,btn_primera,btn_ultima,cuerpo_paginador,pagina_paginador)
{
// pagina_actual--;
var cuerpo = "";
cuerpo_paginador.innerHTML = "";
...
function paginador_primera_tickets_pendientes_empresas(arreglo_rutas,pagina_actual,cantidad_vistas,btn_atras,btn_adelante,btn_primera,btn_ultima,cuerpo_paginador,pagina_paginador){
...
function paginador_ultima_tickets_pendientes_empresas(arreglo_rutas,pagina_actual,cantidad_vistas,btn_atras,btn_adelante,btn_primera,btn_ultima,cuerpo_paginador,pagina_paginador){
var cuerpo = "";
cuerpo_paginador.innerHTML="";
var tamano = arreglo_rutas.length;
var numero_paginas=tamano/cantidad_vistas;
